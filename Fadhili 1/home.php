   ...
   <div class="box-container">
      ...
      <form action="" method="POST">
         ...
         <div class="box">
            ...
            <div class="flex-btn">
               <a href="view-property.php?get_id=<?= $fetch_property['id']; ?>" class="btn">view property</a>
      ...
      <?php
         ...
         echo '<p class="empty">no properties added yet! <a href="post-property.php" style="margin-top:1.5rem;" class="btn">add new</a></p>';
      }
      ?>
